...
final class ImportWorker
{
    ...
    public static function work(PDO $pdo, int $runId, int $uploadId, \debug_sentinel $sentinel): void
    {
        ...
        self::slog($sentinel, 'work.begin', [
            ...
            'columns_map'=>$columnsMap,'transforms'=>$transforms
        ]);
     ...
     * with header exactly: code, ean, name, stock
    ...
    /**
     * Normalize a raw CSV/TXT into canonical CSV (code, ean, name, stock) using exact header names from $headersWanted.
    ...
    private static function ensureMinimalDataTable(PDO $pdo, string $table): void
    {
        ...
        // Create lean schema (matches hs_lib.php)
